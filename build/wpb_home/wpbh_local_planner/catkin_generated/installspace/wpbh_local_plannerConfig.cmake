  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'wpbh_local_planner' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Zhang Wanjie <zhangwanjie@6-robot.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'wpbh_local_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robot/catkin_ws/install/${idir}'.  Ask the maintainer 'Zhang Wanjie <zhangwanjie@6-robot.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${wpbh_local_planner_dep}_FOUND)
      find_package(${wpbh_local_planner_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${wpbh_local_planner_dep} REQUIRED ${depend_list})
  endif()
