...
if("TRUE" STREQUAL "TRUE")
  set(xfyun_waterplus_SOURCE_PREFIX /home/robot/catkin_ws/src/xfyun_waterplus)
...
if(NOT "/home/robot/catkin_ws/devel/include;/home/robot/catkin_ws/src/xfyun_waterplus/include " STREQUAL " ")
  set(xfyun_waterplus_INCLUDE_DIRS "")
  set(_include_dirs "/home/robot/catkin_ws/devel/include;/home/robot/catkin_ws/src/xfyun_waterplus/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'xfyun_waterplus' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Zhang Wanjie <zhangwanjie@6-robot.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'xfyun_waterplus' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robot/catkin_ws/src/xfyun_waterplus/${idir}'.  Ask the maintainer 'Zhang Wanjie <zhangwanjie@6-robot.com>' to fix it.")
    endif()
...
set(xfyun_waterplus_EXPORTED_TARGETS "xfyun_waterplus_generate_messages_cpp;xfyun_waterplus_generate_messages_lisp;xfyun_waterplus_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${xfyun_waterplus_dep}_FOUND)
      find_package(${xfyun_waterplus_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${xfyun_waterplus_dep} REQUIRED ${depend_list})
  endif()
